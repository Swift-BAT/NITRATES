...
from funcs2run_bat_tools import mk_sky_imgs4time_list
...
def cli():
    ...
    parser.add_argument('--dur', type=float,\
            help="Exposure time for each image",\
            default=0.2)
...
def main(args):
    ...
    mk_sky_imgs4time_list(tstarts, dts, args.evfname, args.attfname,\
                args.dmask, args.dname, e0=args.e0, e1=args.e1,\
                bkgvar=True, detapp=True)

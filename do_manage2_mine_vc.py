...
def cli():
    ...
    parser.add_argument('--pbs_fname', type=str,\
            ...
            default='/storage/home/gzr5209/work/BatML_public_repo/NITRATES/submission_scripts/pyscript_template_g3.pbs')
    parser.add_argument('--pbs_rhel7_fname', type=str,\
            help="Name of pbs script",\
            default='/storage/home/gzr5209/work/BatML_public_repo/NITRATES/submission_scripts/pyscript_template_rhel7_g3.pbs')

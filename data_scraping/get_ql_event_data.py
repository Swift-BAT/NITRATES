...
def cli():
    ...
    parser.add_argument('--htmldir', type=str,\
            ...
            default="/home/shared/realtime_workdir/htmls/")
...
def main(args):
    ...
    for obsid, obs_dict in list(obsid_dict.items()):
        ...
        if len(urls2download) > 0:
            ...
            for ev_file_dict in ev_file_dicts:
                ...
                for ii in range(Ngtis):
                    ...
                    db_data_dict['UTCstop'] = met2isot(db_data_dict[\
                                            'METstop'], utcf)
                    db_data_dict['UTCstart'] = met2isot(db_data_dict[\
                                            'METstart'], utcf)
        ...
        if new_obsid:
            ...
            write_new_obsid_line(conn, obsid, data_dict=db_obs_dict, table="SwiftQLeventOBS")
        else:

...
if [ -f "filter_evdata.fits" ]; then
    ...
    python $batml_path'do_manage2_mine_vc.py' --GWname $gwname --do_bkg --do_rates --do_llh --queue jak51_b_g_vc_default --q hprc --N_infov_jobs 260 --N_outfov_jobs 40  > manager.out 2>&1 &
fi

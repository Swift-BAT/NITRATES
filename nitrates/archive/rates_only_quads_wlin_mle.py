...
def do_rate_mle(cnts_per_tbin, bkg_rate_obj, cnts_intp, t_bins0, t_bins1):
    ntbins = len(t_bins0)
    ...
    for i in range(ntbins):
        ...
        bkg_cnts = bkg_rate * bkgdt
        bkg_err = 2.5 * bkg_rate_err * bkgdt
        ...
        res = optimize.fmin(rate_llh2min, x0, args=_args, disp=False, full_output=True)

...
def main(args):
    ...
    logging.basicConfig(filename='bkg_rate_estimation.log', level=logging.DEBUG,\
    ...
    avg_quad_obj, lin_quad_obj, cub_quad_obj =\
        get_avg_lin_cub_rate_quad_obs(quad_dicts, ev_data,\
                            trigtime, ebins0, ebins1,\

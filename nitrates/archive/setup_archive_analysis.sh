...
python $batml_path'mkdb.py' --work_dir $workdir

# cd $workdir

python $batml_path'do_data_setup_archive.py' --work_dir $workdir --evfname $evfname --dmask $dmaskfname --att_fname $attfname

# python $batml_path'do_bkg_estimation_wPSs_archive.py' > bkg_out.log 2>&1

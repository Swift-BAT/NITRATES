...
class Swift_Mask_Interactions(object):
    ...
    def get_trans(self):
        ...
        self.trans[self.does_int_mask] = self.fix_trans[self.does_int_mask] * (
...
def analysis_for_imxy_square(
    ...
    imx_ax = np.arange(imx0, imx1 + dimxy / 2.0, dimxy)
    imy_ax = np.arange(imy0, imy1 + dimxy / 2.0, dimxy)

...
def min_det_fp_nllh(data_counts, bkg_obj, t, dt,\
                     cnts_intp, Ndets, Ndets_total, get_bkg_nllh=False):
            ...
            for jj in range(self.Nfps):
                ...
                for kk in range(ntbins):
                    ...
                    res_dict['bkg_nllh'] = min_det_fp_nllh(cnts_per_tbin[kk],\
                                self.bkg_obj, tbins0[kk], tbin_size,\
                                cnts_intp, Ndets, self.Ndets_tot,\
                                get_bkg_nllh=True)
...
def main(args):
    ...
    rate_llh_obj = rates_fp_llh(imxs, imys, ev_data, bkg_obj,\
                            twind_df, ebins0, ebins1, args.fp_dir,\
                            fp_arr, bl_dmask, drm_dir)

...
def find_peaks2scan(res_df, max_dv=10.0, min_sep=9e-3, max_Npeaks=6,\
                    min_Npeaks=2, minTS=6.0, nllh_name='nllh'):
...
def analysis_for_imxy_square(imx0, imx1, imy0, imy1, bkg_bf_params_list,\
                            ...
                            timeIDs, TS2keep=4.5, max_frac2keep=0.75):
...
def analysis_for_imxy_square(imxs, imys, bkg_bf_params_list,\
                            bkg_mod, flux_mod, ev_data,\
                            ebins0, ebins1, tbins0, tbins1,\
                            timeIDs, TS2keep=None,\
                            max_frac2keep=0.75, do_scan=False):
...
def do_analysis(square_tab, ev_data, flux_mod, rt_dir,\
    ...
    for squareID, square_df in df_sq_grps:
        ...
        try:
            ...
            res_df, peak_res_df = analysis_for_imxy_square(imxs, imys,\
                        bkg_params_list, bkg_mod, flux_mod, ev_data,\
                        ebins0, ebins1, t0s, t1s, timeIDs)
...
def main(args):
    ...
    do_analysis(square_tab, ev_data, flux_mod, rt_dir,\
                    ebins0, ebins1, bl_dmask,\
                    trigtime, work_dir, args.bkg_fname, args.pcfname)

...
def cli():
    ...
    parser.add_argument('--dname', type=str,\
            help="directory for the sim run files",
            default=None)
...
def get_depth_dE4comp(ebins0, ebins1, Eline_bin0s, Eline_bin1s, edeps, zs,
                      Ndets, gamma_percm2, Nzbins=20):
...
def get_depth4lines(Eline_bin0s, Eline_bin1s, edeps, zs, Ndets, gamma_percm2, Nzbins=20):
...
bot_pixids = np.append(np.arange(0, 57, 8, dtype=np.int), np.arange(71, 128, 8, dtype=np.int))
top_pixids = np.append(np.arange(7, 64, 8, dtype=np.int), np.arange(64, 121, 8, dtype=np.int))
Ntot_dets = 32768
...
def get_dist_dicts(dname):
    ...
    for i in range(NPrimary_Es):
        ...
        line_ebins0 = np.array([PrimaryE-EK1_TE-0.1, PrimaryE-EK1_CD-0.1, PrimaryE-0.1])
        line_ebins1 = np.array([PrimaryE-EK1_TE+0.1, PrimaryE-EK1_CD+0.1, PrimaryE+0.1])
...
def get_dist_dicts2(dname, theta, phi):
    ...
    for i in range(NPrimary_Es):
        ...
        if (theta > 70.0 and theta < 80.0) or (theta > 100.0 and theta < 110.0):
            ...
            if phi > 25.0:
                cols = [(0,13),(13,14),(14,15),(15,16),(0,13),(0,13),(0,13)]
                rows = [(0,13),(0,16),(0,16),(0,16),(13,14),(14,15),(15,16)]
            ...
            if phi > 20.0:
                cols = [(0,11),(11,12),(12,13),(13,14),(14,15),
                        (15,16),(0,11),(0,11),(0,11),(0,11),(0,11)]
                rows = [(0,11),(0,16),(0,16),(0,16),(0,16),(0,16),
                        (11,12),(12,13),(13,14),(14,15),(15,16)]
                rows = [(5,16),(0,16),(0,16),(0,16),(0,16),(0,16),
                        (0,1),(1,2),(2,3),(3,4),(4,5)]

            elif phi > 5.0:
                cols = [(0,11),(11,12),(12,13),(13,14),(14,15),(15,16),(0,11),(0,11),(0,11)]
                rows = [(0,13),(0,16),(0,16),(0,16),(0,16),(0,16),(13,14),(14,15),(15,16)]
                rows = [(3,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,1),(1,2),(2,3)]
            ...
            if phi > 20.0:
                cols = [(0,8),(8,9),(9,10),(10,11),(11,12),(12,13),(13,14),(14,15),(15,16),
                        (0,8),(0,8),(0,8),(0,8),(0,8),(0,8),(0,8),(0,8)]
                rows = [(0,8),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),
                        (8,9),(9,10),(10,11),(11,12),(12,13),(13,14),(14,15),(15,16)]
                rows = [(8,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),
                ...
                cols = [(0,8),(8,9),(9,10),(10,11),(11,12),(12,13),(13,14),(14,15),(15,16),
                        (0,8),(0,8),(0,8),(0,8)]
                rows = [(0,12),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),
                        (12,13),(13,14),(14,15),(15,16)]
                rows = [(4,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),
                        (0,1),(1,2),(2,3),(3,4)]

            else:
                cols = [(0,8),(8,9),(9,10),(10,11),(11,12),(12,13),(13,14),(14,15),(15,16)]
                rows = [(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,16)]
        ...
        #     bl_cols = np.zeros(len(bl), dtype=np.bool)
            bl_cols = (detxs>=detxs_by_sand0[col0])&(detxs<=detxs_by_sand1[col1-1])
            bl_rows = (detys>=detys_by_sand0[row0])&(detys<=detys_by_sand1[row1-1])
...
#             orientation_names = ['NonEdges', 'right', 'left', 'top', 'bot', 'rightmost', 'botmost']
            ...
            if phi > 20.0:
                ...
                cols = [(0,11),(11,12),(12,13),(13,14),(14,15),(15,16),(0,11),(0,11)]
                rows = [(0,14),(0,16),(0,16),(0,16),(0,16),(0,16),(14,15),(15,16)]
                rows = [(2,16),(0,16),(0,16),(0,16),(0,16),(0,16),(0,1),(1,2)]
            ...
            if phi > 20.0:
                cols = [(0,12),(12,13),(13,14),(14,15),(15,16),
                        (0,12),(0,12),(0,12),(0,12)]
                rows = [(0,12),(0,16),(0,16),(0,16),(0,16),
                        (12,13),(13,14),(14,15),(15,16)]
                rows = [(4,16),(0,16),(0,16),(0,16),(0,16),
                        (0,1),(1,2),(2,3),(3,4)]

            elif phi > 5.0:
                cols = [(0,12),(12,13),(13,14),(14,15),(15,16),(0,12),(0,12)]
            ...
            if phi > 20.0:
                cols = [(0,13),(13,14),(14,15),(15,16),
                        (0,13),(0,13),(0,13)]
                rows = [(0,13),(0,16),(0,16),(0,16),
                        (13,14),(14,15),(15,16)]
                rows = [(3,16),(0,16),(0,16),(0,16),
                        (0,1),(1,2),(2,3)]
            elif phi > 5.0:
...
def main(args):
    ...
    if theta < 70.0:
        ...
        line_dicts, comp_dicts, zbins, Primary_Es = get_dist_dicts2(dname,\
                                                                theta, phi)
